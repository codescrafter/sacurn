...
const UserCard = (props) => {
  return (
    <Card className={props.className}>
      <h1 className="2xl:mt-7.5 2xl:mb-4.2 2xl:mx-15 2xl:text-xl 2xl:font-bold  text-navy-blue">
        {props.accType}
      </h1>
      <div className="flex flex-col relative w-max">
        <Image
          className={`2xl:border-4  rounded-full border-navy-blue 2xl:w-21.2 2xl:h-21.2`}
      ...
      <p className="2xl:text-sm 2xl:mb-6 text-dark-grey">{props.email}</p>
...
const ProfileButton = (props) => {
  return (
    <button
      className={`2xl:px-4 2xl:py-1.5 border border-grey  rounded-md ${props.className}`}
    >
