      ...
      <div className="flex flex-row mt-7.7 ">
        <div className="relative flex flex-col items-end -translate-x-9">
          ...
          <div className="flex flex-col items-center py-4.7 pl-4 pr-6.2 styledDiv">
            ...
            <div className="text-right">
              ...
              <h3 className="text-2xl font-medium  mb-0.7">
                {product.methodology}
              </h3>
              <p className="w-59.2 text-base mb-2.5 font-thin">
        ...
        <div className="flex flex-col">
          <div className="border border-white flex flex-col">
            <h1 className="text-3.5xl font-medium mt-6.2 ml-13 mb-3.5">
              About
            </h1>
          ...
          <div className="flex flex-row h-full w-full">
            <div className="flex flex-col border border-white mt-2.5">
              <Image className="mx-11.5 mt-4.7 hover:cursor-pointer" src={playbutton} />
              <p className="mx-auto mb-1.2">Watch Video</p>
            </div>
            <Image className="mx-auto" src={standard1} />
            <Image className="mx-auto" src={standard2} />
          </div>
        </div>
      </div>
    </div>
