    ...
    <div className="relative w-full flex flex-col mt-37">
      <div className="w-full flex flex-row justify-between">
        <div className="flex flex-col">
          <h1 className="2xl:text-4.5xl xl:text-3.5xl">{product.name}</h1>
          <p className="2xl:text-2.5xl xl:text-1.5xl font-thin">{product.developer}</p>
        </div>
      ...
      <div className="flex flex-row mt-7.7 ">
        <div className="relative flex flex-col items-end 2xl:-translate-x-9 xl:-translate-x-4">
          <div className="relative styledDiv py-5.2 2xl:px-17.7 xl:px-10 items-center mb-4">
            <h1 className="2xl:text-3.5xl xl:text-2.5xl mb-3.2 font-medium">Profile</h1>
          ...
          <div className="flex flex-col items-center py-4.7 2xl:pl-4 xl:pl-0 2xl:pr-6.2 xl:pr-3.5 styledDiv">
            <Image className="mb-2.7" src={methodology} />
            <div className="text-right">
              <h1 className="2xl:text-3.5xl xl:text-2.5xl font-medium mb-2">Methodology</h1>
              <h3 className="2xl:text-2xl xl:text-1.5xl font-medium  mb-0.7">
                {product.methodology}
              </h3>
              <p className="2xl:w-59.2 xl:w-51 text-base mb-2.5 font-thin">
        ...
        <div className="flex flex-col">
          <div className="border border-white flex flex-col">
            <h1 className="2xl:text-3.5xl xl:text-3xl font-medium mt-6.2 ml-13 mb-3.5">
              About
            </h1>
            <div className="flex flex-row mb-8.2 mr-6.5">
              <div className="px-0.5 h-[60%] rounded-md bg-white ml-6.7 mr-4.2"></div>
              <p className="2xl:w-[640px] xl:w-[400px] 2xl:text-2xl xl:text-xl">{product.about}</p>
            </div>
          </div>
          <div className="flex flex-row h-full w-full">
            <div className="flex flex-col border border-white mt-2.5">
              <Image className="2xl:mx-11.5 xl:mx-4.5 mt-4.7 hover:cursor-pointer" src={playbutton} />
              <p className="mx-auto 2xl:text-auto xl:text-sm mb-1.2">Watch Video</p>
            </div>
            <Image className="2xl:w-52 xl:w-52 mx-auto" src={standard1} />
            <Image className="2xl:w-28 xl:w-28 mx-auto" src={standard2} />
          </div>
        </div>
      </div>
    </div>
