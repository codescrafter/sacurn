...
export const Policy: string = `感謝您使用土星永續股份有限公司（下稱「本公司」）所提供的平台（下稱「本平台」）以進行本公司所提供之碳權憑證申購、銷售以及專案碳權抵換服務（下合稱「本服務」），您茲同意當您存取本公司網站（[*請輸入網址]，下稱「本網站」）並使用本服務時， 將受以下條款及條件（下稱「本服務條款」）所拘束。敬請詳閱本協議（定義如後，包含本服務條款）， 如不同意本協議之內容，請勿註冊帳號、存取本網站或使用本服務。
請注意，在您使用本服務前，必先詳閱本公司個人資料保護政策（下稱「隱私權政策」）以及 Cookie 政策（下稱「Cookie 政策」），如您對「隱私權政策」或「Cookie 政策」有疑義或無法接受，請先與本公司確認，切勿逕行使用本服務。您將與本公司訂立之協議包含本服務條款、隱私權政策、Cookie 政策（下合稱「本協議」）。本公司有權隨時變更、修訂或更新本協議內容；針對本服務，未來可能增訂額外的條款，如果您使用本服務， 則該等額外條款也會構成本協議之一部。若本協議有任何後續變更、修訂或更新的情形，如您不同意該等後續的變更、 修訂或更新條款，您仍可存取您的交易記錄和碳權憑證，但您可能無法繼續使用本公司提供之完整服務。
