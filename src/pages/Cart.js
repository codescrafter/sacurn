    ...
    <div className="bg-neutral-150 h-screen overflow-hidden">
      ...
      <div className="flex justify-between my-4 pl-13 pr-10">
        ...
        <div className="flex items-center">
          ...
          <img src={"/images/cart/ic_delete.svg"} width={28} height={34} />
        </div>
      </div>
...
const CartItem = ({ img, memberCode, heading, price, left, total }) => {
  ...
  return (
    <div
      className={`flex items-center py-4.5 border-2 rounded-[10px] direction-ltr shadow-cart-item ${rowSelected
    ...
    >
      <div className="flex items-center">
        <div className="ml-7.5 mr-4">
          {rowSelected ? (
            <img src={"/images/cart/ic_check.svg"} width={29} height={29} />
          ) : (
            <img src={"/images/cart/ic_uncheck.svg"} width={29} height={29} />
          )}
        </div>

        <img src={img} width={114} height={114} className="object-cover" />
        <div className="ml-6 flex flex-col justify-between h-full">
          <p className="text-[10.6px] font-medium text-black">{memberCode}</p>
          <p
            className={`font-bold text-xl leading-[18px] w-[316px] mr-3 mt-3 mb-3 ${rowSelected ? "text-bright-blue" : "text-black"
              }`}
          >
            {heading}
          </p>
