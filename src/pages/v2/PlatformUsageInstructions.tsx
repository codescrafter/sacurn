...
const PlatformUsageInstructions = () => {
  return (
    <div className="w-[90%] h-[600px]rounded-lg bg-trans-white mt-4 p-2 pt-4 ml-15 min-[1400px]:mt-[40px] min-[1700px]:mt[150px]">
      ...
      <div className="h-[500px] overflow-y-scroll yellowScroll  min-[1400px]:h-[684px]">
