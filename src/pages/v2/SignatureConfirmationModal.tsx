...
import { ModalCloseError } from '@/error';
...
type RejectResponse = string;

type SignatureConfirmationModalProps = {
  title: string;
  type: CardType;
  component?: ReactNode;
...
const PromiseSignatureConfirmationModal = createModal<SignatureConfirmationModalProps>(SignatureConfirmationModal);
export default PromiseSignatureConfirmationModal;
