...
function twcaVerifyLibSSImpl() {
	...
	this.IDPaaSCapiAgentCheck = function (cbf) {
		...
		if (this.capiAgent == null)
			this.capiAgent = initCapiAgentForChrome();
		try {
	...
	this.IDPaaSPostAlsUrl = function (url, eddarbank, rbanktoken) {
        ...
        newWindowForBankAccountLogin = window.open("", "newWindowForBankAccountLogin", 'width=' + w + ',height=' + h + ',left=' + left + ',top=' + top);
