...
export class DjRestAuthService {
   ...
   * @throws ApiError
   */
  public djRestAuthLoginCreate(requestBody: Login): CancelablePromise<JWT> {
   ...
   * @throws ApiError
   */
  public djRestAuthPasswordChangeCreate(requestBody: PasswordChange): CancelablePromise<RestAuthDetail> {
    return this.httpRequest.request({
      method: 'POST',
   ...
   * @throws ApiError
   */
  public djRestAuthPasswordResetCreate(requestBody: PasswordReset): CancelablePromise<RestAuthDetail> {
    return this.httpRequest.request({
      method: 'POST',
      url: '/dj-rest-auth/forgot_password/',
      body: requestBody,
      mediaType: 'application/json'
    });
  }
   ...
   * @throws ApiError
   */
  public djRestAuthPasswordResetConfirmCreate(requestBody: PasswordResetConfirm): CancelablePromise<RestAuthDetail> {
    return this.httpRequest.request({
      method: 'POST',
   ...
   * @throws ApiError
   */
  public djRestAuthTokenRefreshCreate(requestBody: TokenRefresh): CancelablePromise<TokenRefresh> {
    return this.httpRequest.request({
      method: 'POST',
   ...
   * @throws ApiError
   */
  public djRestAuthTokenVerifyCreate(requestBody: TokenVerify): CancelablePromise<TokenVerify> {
    return this.httpRequest.request({
      method: 'POST',
   ...
   * @throws ApiError
   */
  public djRestAuthUserUpdate(requestBody: UserDetails): CancelablePromise<UserDetails> {
    return this.httpRequest.request({
      method: 'PUT',
      url: '/dj-rest-auth/user/',
      body: requestBody,
   ...
   * @throws ApiError
   */
  public djRestAuthUserPartialUpdate(requestBody?: PatchedUserDetails): CancelablePromise<UserDetails> {
    return this.httpRequest.request({
      method: 'PATCH',
      url: '/dj-rest-auth/user/',
      body: requestBody,
