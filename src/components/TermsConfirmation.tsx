        ...
        <div className="bg-white rounded-2.5xl shadow-company-registration-input py-3 px-4 h-[50vh] w-[95%] mb-3 relative">
          <div className="overflow-y-scroll yellowScroll w-[calc(100%-5px)] h-full">
            <div className="text-mdbase font-bold break-normal break-keep whitespace-pre-wrap w-[95%]">
              <div className="text-left text-mdbase font-bold break-normal break-keep whitespace-pre-wrap w-[95%]">
                <p>
                  感謝您使用土星永續股份有限公司(下稱「本公司」)所提供的平台(下稱「本平台」)以進
                  行本公司所提供之碳權憑證申購、銷售以及專案碳權抵換服務(下合稱「本服務」)，您茲同
                  ...
                  無法接受，請先與本公司確認，切勿逕行使用本服務。您將與本公司訂立之協議包含本服務條
                  款、隱私權政策、Cookie 政策(下合稱「本協議」)。本公司有權隨時變更、修訂或更新本
                  協議內容;針對本服務，未來可能增訂額外的條款，如果您使用本服務， 則該等額外條款也會
                  構成本協議之一部。若本協議有任何後續變更、修訂或更新的情形，如您不同意該等後續的變 更、
                  修訂或更新條款，您仍可存取您的交易記錄和碳權憑證，但您可能無法繼續使用本公司提 供之完整服務。
                  本公司與您之間同意以電子文件為表示方法，依本協議交換之電子文件，如其內容可完整呈現
                  且可於日後取出供查驗者，其效力與書面文件相同。但依法令有強制規定排除適用者，不在此
                  限。上述電子文件係以文字、聲音、影片、圖像、內容符號或其他資料，以電子之方式所製成足以
