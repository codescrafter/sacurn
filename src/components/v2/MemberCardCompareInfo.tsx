  ...
  return (
    <>
      {isCardComparisonModalOpen && (
        <>
          <Backdrop open={isCardComparisonModalOpen} onClick={() => toggleCardComparison()} sx={{ zIndex: '20' }} />

          <div className="w-[70vw] right-7 top-26.7 absolute bg-white h-[76vh] rounded-[20px] pt-[56px] pl-[42px] pr-[25px] pb-6 z-[1050]">
            <img
            ...
            />
            <div className="overflow-y-scroll yellowScroll w-full h-full pr-5">
              <div className="w-full min-h-[930px]">
                <div className="flex flex-1 flex-col items-center bg-offwhite backdrop:blur-0 mb-2">
                  {MEMBERSHIP_DATA.map((data, idx) => (
                    <div key={data.id} className="flex flex-row w-full">
                      <div className="flex flex-row w-1/5">
                        {!data.variation && (
                          <h1
                            className={classNames(
                              'flex flex-1 border border-mildGrey justify-center items-center p-3',
                              {
                                'rounded-tl-[16px]': idx === 0,
                                'rounded-bl-[16px]': idx === MEMBERSHIP_DATA.length - 1
                              }
                            )}
                          >
                            {data.title}
                        ...
                        {data.variation == 'duo' && (
                          <div className="flex flex-1 border border-mildGrey w-1/5 justify-center text-center items-center p-2">
                            <div className="relative whitespace-pre-wrap">
                              {data.title}
                              <span className="absolute text-xs -right-4 -top-3 whitespace-pre-wrap">
                                {data.subtitle1}
                              </span>
                      ...
                      <div
                        key={data.id}
                        className={classNames('flex w-full border border-mildGrey', {
                          'rounded-tr-[16px]': idx === 0,
                          'rounded-br-[16px]': idx === MEMBERSHIP_DATA.length - 1
                        })}
                      >
                            ...
                            {data.id == 1 && (
                              <div>
                                ...
                                {item.level == 3 && (
                                  <div
                                    className={classNames(
                                      'relative p-3 flex flex-col flex-1 justify-center items-center bg-bgBlue rounded-tr-[16px]'
                                    )}
                                  >
                                    <img
                                      className="absolute mr-10 w-2 left-0 md:-left-[0.40px] md:w-2.5 lg:-left-0.5 lg:w-[14px] xl:-left-[0.20px] xl:w-4"
