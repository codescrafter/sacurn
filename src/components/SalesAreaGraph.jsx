  ...
  return (
    <GraphCard className="h-[347px] flex items-center justify-center relative z-[999]">
      ...
      <div className="absolute z-40 -right-9 2xl:-right-5 transform rotate-90">
        <Button
          className={`font-medium text-xs 2xl:text-sm !text-grey flex-shrink-0 ${activeButton === 1
        ...
        <Button
          className={`font-medium text-[11px] !text-grey 2xl:text-[13px] flex-shrink-0 ${activeButton === 2
            ? "!bg-transparent !shadow-graph-btn"
