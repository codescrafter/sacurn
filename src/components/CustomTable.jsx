            ...
            <thead className="sticky -top-1 z-10">
              <tr className="!bg-neutral-150">
                {tableHeadings.map((item, index) => (
                  <th
                    scope="col"
                    className={`pb-3 pt-1 text-left whitespace-nowrap text-base xl:text-lg font-normal text-grey ${index === 0 ? "pl-2 2xl:pl-[33px]" : "px-2 2xl:px-8"
                      }`}
                    key={item}
                  >
                    {item}
              ...
              {tableBody.map((item, index) => (
                <Fragment key={item.id}>
                  <tr className={`bg-white row group h-[95px]`}>
                    <td
                      className={`py-3 pl-2 2xl:pl-[33px] pr-2 2xl:pr-4 ${page === "historical_order"
                        ? "xl:w-48 w-36"
                        : "xl:w-40 xl:pr-10"
                        }`}
                    >
                      <span
                        className={`flex text-base 2xl:text-xl items-center w-24 ${page === "historical_order"
                      ...
                      >
                        ...
                        {page === "historical_order" && (
                          <img
                            ...
                            height={8}
                            alt="Cherven Icon"
                            className={`ml-2 w-3 h-3 cursor-pointer hidden group-hover:block ${expandedRowIndex === index &&
                    ...
                    <td
                      className={`py-3 px-2 2xl:px-8 text-base 2xl:text-xl w-72 2xl:w-96 relative ${page === "historical_order"
                        ? "text-black font-medium"
                        : "text-dark-grey"
                        }`}
                    >
                    ...
                    <td
                      className={`py-3 px-4 2xl:px-8 text-base 2xl:text-xl ${page === "operation_page" && "!text-dark-grey"
                        } ${page === "historical_order" &&
                          (index === 2 || index === 3)
                          ? "text-light-red"
                          : "text-light-green"
                    ...
                    <td
                      className={`py-3 px-2 2xl:px-8 text-base 2xl:text-xl ${page === "historical_order"
                        ? "text-black font-medium"
                        : "text-dark-grey"
                        }`}
                    >
                    ...
                    <td
                      className={`py-3 px-2 2xl:px-8 text-dark-grey whitespace-nowrap text-base 2xl:text-xl ${page === "operation_page" && "!text-dark-grey"
                        } ${page === "historical_order" &&
                          (index === 2 || index === 3)
                          ? "text-light-red"
                          : "text-light-green"
                    ...
                    {page === "operation_page" && (
                      <td
                        className={`py-3 px-2 2xl:px-8 whitespace-nowrap text-base 2xl:text-xl ${page === "historical_order"
                          ? "text-black font-medium"
                          : "text-dark-grey"
                          }`}
                      >
