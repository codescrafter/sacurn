  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'certificate-shadow': '0px 0px 24px 0px rgba(0, 0, 0, 0.25)',
        'button-box-shadow': '0px 2px 4px 0px rgba(0, 0, 0, 0.15)',
        'button-delete-shadow': '0px 0px 4px 0px rgba(0, 0, 0, 0.35)'
      },
      backgroundImage: {
